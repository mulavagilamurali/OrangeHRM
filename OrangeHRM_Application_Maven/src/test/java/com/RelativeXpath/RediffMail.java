...
public class RediffMail {
	...
	public void reddIff() throws InterruptedException, IOException {
		...
		Thread.sleep(5000);
		 ...
		 FileUtils.copyFile(takingScreenshot,new File("E:\\SriniSir_AutomationScripts\\OrangeHRM_Application_Maven\\ScreenShots\\RedIffEmail_Screenshots\\redIffcreataccount.png"));
